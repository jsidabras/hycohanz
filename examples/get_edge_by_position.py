...
raw_input('Press "Enter" to get a handle to the edge of the circle.>')
...
# index.
edgehandle = hfss.get_edge_by_position(
    oEditor, 
    circlename, 
    hfss.Expression("1m"), 
    hfss.Expression("2.5m"), 
    hfss.Expression("3m"),
    )

print('edgehandle: ' + str(edgehandle))
